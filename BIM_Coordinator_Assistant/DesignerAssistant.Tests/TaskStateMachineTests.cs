...
public sealed class TaskStateMachineTests
{
    ...
    [InlineData(TaskState.Execution, TaskState.ExecutionInterrupted)]
    [InlineData(TaskState.ExecutionInterrupted, TaskState.Execution)]
    [InlineData(TaskState.ExecutionInterrupted, TaskState.Validation)]
    [InlineData(TaskState.ExecutionInterrupted, TaskState.Planning)]
